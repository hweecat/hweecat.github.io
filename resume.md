...
* Lead the strategic design, technical roadmap, and overall implementation of Superbank's MLOps platform architecture using FastAPI, Apache Spark, Airflow, Amazon Data Firehose, PostgreSQL, Terraform, GitLab CI/CD, Grafana, CloudWatch and OpenSearch, enabling full-cycle development and deployment of machine learning models as APIs and batch inference workflows that enhance loan underwriting decision-making and identity fraud prevention while ensuring near-real-time service-level observability and model performance monitoring.
* Led cross-functional requirements analyses, design and implementation of data products that propose customer status changes to banking systems and in-app customer experience based on customer-initiated activities across all product verticals, enabling automated account dormancy flows to minimize the risk of fraudulent activity.
* Achieved >80% cost reduction and >85% faster compute performance in customer portfolio computation for customer repeat due diligence using cumulative table design. Presented results to C-suite with proposal to scale optimization wins across use cases and data marts to enable AI initiatives.
* Designed and implemented a data quality and reconciliation workflow that delivers daily data reconciliation and data quality reports to Slack, providing a unified interface for backend teams to monitor data consistency across systems and enabling data-driven tech debt prioritization across product squads. Proposed solution was championed by senior management to scale reconciliation across multiple systems within Superbank.
* Operationalized procedures for handling upstream issues impacting backend workers that leverage Snowflake to drive in-app customer experience.
* Mentored a senior engineer in the timely migration of Superbank's data pipelines, applications and platform infrastructure to Snowflake key-pair authentication, providing guidance on role-based access control (RBAC) with Terraform and secrets management with AWS Secrets Manager and Vault to ensure seamless integration with Snowflake service users.
...
* Successfully onboarded 3 senior/mid-level engineers by providing structured mentorship and guidance on technical direction, data engineering best practices, and cross-functional collaboration.
